...
class _ChatChatDetailState extends State<ChatChatDetail> {
  ...
  void initState() {
    ...
    //   await blocChat.getListChat(widget.user.id, roomId);
    //   await blocChat.joinRoom();
    //   // ....
    // }
  }
            ...
            builder: (context, snapshotChat) {
              return StreamBuilder(
                  ...
                  builder: (context, snapshotCurrentUser) {
                    if (snapshotChat.hasError || snapshotCurrentUser.hasError) {
                      // return Text(snapshotChat.error.toString() +
                      //     snapshotCurrentUser.error.toString());
                              ...
                              child: Container(
                                child: NotificationListener<ScrollNotification>(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemCount: snapshotChat.data.length,
                                      itemBuilder:
                                          (BuildContext context, int index) {
                                        final ChatModel message =
                                            snapshotChat.data[index];
